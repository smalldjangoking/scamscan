...
import { deleteReport } from "../utils/hook.js"
    ...
    return (
        <section className="relative min-h-screen" >
            ...
            <div className="relative container mx-auto py-10 px-2 md:py-20">
                <div className="flex justify-between items-center mb-5">
                    ...
                    {reportData?.user && store.userId === reportData.report.user_id && (
                        <div className="flex items-center ml-auto">
                            <Button onClick={() => reportDeleteHandler(reportData?.report.id, reportData?.report.report_title)} variant="ghost">
                                <Trash2 />
                            </Button>
                        </div>
                    )}
                ...
                {reportData && !reportIsError && (
                    <div
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <TiptapViewer html={reportData?.report.report_description} edit={isEditing} />
                        </div>
                ...
                {reportIsError && (
                    <div className="col-span-full flex flex-col justify-center items-center py-20 gap-4">
                        ...
                        <p className="text-center text-muted-foreground">
                            Oops! Unable to load the report. It might have been removed or the link is incorrect.
                        </p>
                ...
                {/* Comments Section */}
                {!reportIsLoading && reportData.report && (
                    <Comments reportId={id} report_owner={reportData.report.user_id} />
                )}
            </div >
